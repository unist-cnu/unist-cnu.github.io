                  ...
                  <tbody>
                    ...
                    <tr>
                        ...
                        <td className="materialsCell">
                          <a className="matLink" href="/slides/example.pdf" target="_blank" rel="noreferrer">Slides</a>
                          <span className="matSep">·</span>
                          <a className="matLink" href="/slides/example.pdf" target="_blank" rel="noreferrer">Ref</a>
                        </td>
                      </tr>
